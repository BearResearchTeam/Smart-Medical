...
namespace Smart_Medical.Migrations
{
    ...
    [Migration("20250711133551_UpdateT_DictionaryType.DictionaryLabel.TypeInt")]
    partial class UpdateT_DictionaryTypeDictionaryLabelTypeInt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Smart_Medical.Dictionarys.DictionaryType", b =>
                {
                    ...
                    b.Property<int>("DictionaryLabel")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Smart_Medical.DoctorvVsit.DoctorAccount", b =>
                {
                    ...
                    b.Property<string>("DoctorGoodat")
                        .IsRequired()
                        .HasColumnType("longtext");

                    b.Property<string>("Doctorimgs")
                        .IsRequired()
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("Smart_Medical.DoctorvVsit.DoctorAudit", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("AppDoctorAudits", (string)null);
                });
            ...
            modelBuilder.Entity("Smart_Medical.Equipment.EquipmentManagement", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("AppEquipmentManagements", (string)null);
                });
            ...
            modelBuilder.Entity("Smart_Medical.Medical.Sick", b =>
                {
                    ...
                    b.ToTable("AppSicks", (string)null);
                });
            ...
            modelBuilder.Entity("Smart_Medical.RBAC.Permission", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Smart_Medical.RBAC.UserPatient", b =>
                {
                    ...
                    b.ToTable("AppUserPatients", (string)null);
                });
            ...
            modelBuilder.Entity("Smart_Medical.RBAC.RolePermission", b =>
                {
                    b.HasOne("Smart_Medical.RBAC.Permission", "Permission")
                        .WithMany("RolePermissions")
                        .HasForeignKey("PermissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Smart_Medical.RBAC.Role", "Role")
                        .WithMany("RolePermissions")
            ...
            modelBuilder.Entity("Smart_Medical.RBAC.UserPatient", b =>
                {
                    b.HasOne("Smart_Medical.Patient.BasicPatientInfo", "Patient")
                        .WithMany("UserPatients")
                        .HasForeignKey("PatientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Smart_Medical.RBAC.User", "User")
                        .WithMany("UserPatients")
